...
import { allFeedbacksByBook } from '../fn/feedback/all-feedbacks-by-book';
import { AllFeedbacksByBook$Params } from '../fn/feedback/all-feedbacks-by-book';
...
export class FeedbackService extends BaseService {
  ...
  /** Path part for operation `allFeedbacksByBook()` */
  static readonly AllFeedbacksByBookPath = '/feedback/book/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `allFeedbacksByBook()` instead.
   *
   * This method doesn't expect any request body.
   */
  allFeedbacksByBook$Response(params: AllFeedbacksByBook$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseFeedbackResponse>> {
    return allFeedbacksByBook(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `allFeedbacksByBook$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  allFeedbacksByBook(params: AllFeedbacksByBook$Params, context?: HttpContext): Observable<PageResponseFeedbackResponse> {
    return this.allFeedbacksByBook$Response(params, context).pipe(
