package com.himanshu.NovelNet.handler;
...
import static com.himanshu.NovelNet.handler.BusinessErrorCodes.*;
...
//
    ...
    public ResponseEntity<ExceptionResponse> handleException(OperationNotAllowedException exp) {
        return ResponseEntity
                .status(BAD_REQUEST)
                .body(
                        ExceptionResponse.builder()
